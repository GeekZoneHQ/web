...
class Member(models.Model):
    ...
    profile_image = models.ImageField(upload_to="images/", blank=True, verbose_name="Selfie")
    telephone = models.CharField(max_length=255, blank=True, verbose_name="Phone number")
    minecraft_username = models.CharField(max_length=255, blank=True, verbose_name="Minecraft username")
    ...
    gdpr_likeness = models.BooleanField(default=False, verbose_name="Likeness")
    gdpr_sms_updates = models.BooleanField(default=False, verbose_name="SMS updates")
    gdpr_sms_notifications = models.BooleanField(default=False, verbose_name="SMS notifications")
    gdpr_email_updates = models.BooleanField(default=False, verbose_name="Email updates")
    gdpr_email_notifications = models.BooleanField(default=False, verbose_name="Email notifications")
    gdpr_telephone_updates = models.BooleanField(default=False, verbose_name="Phone updates")
