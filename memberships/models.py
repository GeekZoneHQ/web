...
class Member(models.Model):
    ...
    gdpr_likeness = models.BooleanField(default=False)
    gdpr_sms_updates = models.BooleanField(default=False)
    gdpr_sms_notifications = models.BooleanField(default=False)
    gdpr_email_updates = models.BooleanField(default=False)
    gdpr_email_notifications = models.BooleanField(default=False)
    gdpr_telephone_updates = models.BooleanField(default=False)
