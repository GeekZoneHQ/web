...
8. Run the local server `python manage.py runserver`. If you navigate to `http://localhost:800/memberships/register` in your browser you should now see the app. You can press control-c in the terminal to exit the server.
